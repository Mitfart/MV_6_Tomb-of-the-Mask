...
- Level cell: `[top, down, left, right]`; `#` wall, `^` spike, `.` empty, `P` spawn, `B` bat, `T` turret, `F` fish, `o` point, `C` coin, `G` coin boost. B/T position sets first move/fire direction; F expands 1×1 to 3×3.
